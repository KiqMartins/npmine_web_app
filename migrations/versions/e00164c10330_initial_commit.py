...
Revision ID: e00164c10330
Revises: 
Create Date: 2024-03-08 15:00:20.302333
...
def upgrade():
    ...
    sa.Column('class_results', sa.String(length=50), nullable=True),
    sa.Column('superclass_results', sa.String(length=50), nullable=True),
    sa.Column('pathway_results', sa.String(length=50), nullable=True),
    sa.Column('isglycoside', sa.String(length=50), nullable=True),
